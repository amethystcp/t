...
int main(void)
{
  ...
  /* บังคับให้ขา CS เป็น High ก่อน (เพื่อป้องกันเซนเซอร์รวนตอนเปิดเครื่อง) */
  HAL_GPIO_WritePin(ICM45686_CS_GPIO_Port, ICM45686_CS_Pin, GPIO_PIN_SET);

  /* สั่งเริ่มต้นการทำงานของเซนเซอร์ */
  ICM45686_Init(&hspi1);
  ...
  while (1)
  {
      /* อ่านค่าจากเซนเซอร์ 6 แกน */
      ICM45686_ReadData(&hspi1, &imu_data);
